...
export const AudioMessage = styled(View) <{ isMine: boolean }>`
  flex-direction: row;
  align-items: center;
  padding: 12px 16px;
  border-radius: 20px;
...
export const BudgetServiceAccessButtonText = styled(Text)`
  font-family: ${({ theme }) => theme.FONT_FAMILY.MEDIUM};
  font-size: ${({ theme }) => theme.FONT_SIZE.SSM}px;
  color: ${({ theme }) => theme.COLORS.BLACK};
`;

export const BudgetResponseContainer = styled(View)`
  margin: 20px 0;
  padding: 20px;
  background-color: ${({ theme }) => theme.COLORS.WHITE};
  border-radius: 16px;
...
export const BudgetResponseHeader = styled(View)`
  margin-bottom: 16px;
`;
...
export const BudgetServiceTitle = styled(Text)`
  font-family: ${({ theme }) => theme.FONT_FAMILY.MEDIUM};
...
export const RefazerText = styled(Text)`
  font-family: ${({ theme }) => theme.FONT_FAMILY.MEDIUM};
  font-size: ${({ theme }) => theme.FONT_SIZE.SM}px;
  color: ${({ theme }) => theme.COLORS.GREY};
`;

export const ContratarButton = styled(TouchableOpacity)`
  padding: 12px 28px;
  border-radius: 24px;
  background-color: ${({ theme }) => theme.COLORS.BLACK};
`;

export const ContratarText = styled(Text)`
  font-family: ${({ theme }) => theme.FONT_FAMILY.MEDIUM};
  font-size: ${({ theme }) => theme.FONT_SIZE.SM}px;
  color: ${({ theme }) => theme.COLORS.WHITE};
`;
